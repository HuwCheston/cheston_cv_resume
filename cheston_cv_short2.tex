...
\textbf{Ph.D.}, Centre for Music \& Science, University of Cambridge  \hfill \emph{expected} October, 2024   \\
\-\hspace{.25in} \textbf{Thesis:} New Methods in Computational Analysis and Modeling of Musical Improvisation \\
\-\hspace{.25in} \emph{Applied techniques from machine learning and data science to generate end-to-end performer} \\
\-\hspace{.25in} \emph{identification model from commercial audio recordings}

\textbf{MSt., Music (Music Psychology)}, University of Oxford (\emph{Distinction}) \hfill October, 2020\\
...
\textbf{Supervisor \& Guest Lecturer}, University of Cambridge \hfill January 2022 –
\begin{itemize}
\setlength\itemsep{0pt}
    \item[--]Delivered over 100 small-group supervisions for Undergraduate students (natural sciences \& humanities courses) on: (\emph{i}) analysing audio recordings, (\emph{ii}) introduction to programming in Python and R, (\emph{iii}) visualising and simulating data. 
...
\setlength\itemsep{0pt}
    ...
    \item[--]Used time series analysis to model performance strategies found in online music making
...
\setlength\itemsep{0pt}
    ...
    \item[--]\textbf{Developer Tools}: \faGit, \LaTeX, Docker, Google Cloud Platform, PyCharm, Jupyter
    \item[--]\textbf{Libraries}: pandas, NumPy, Matplotlib, Matplotlib, Scikit-learn, SciPy, Statsmodels, OpenCV
\vspace{0pt}
\end{itemize}
%----------------------------------------------------------------------------------------
%	REFERENCES
