...
%------------------------------------------------------------==--------------
\vspace{8pt}
\centerline{\href{mailto:hwc31@cam.ac.uk}{\underline{Email}} \hspace{4pt} $\mid$ \hspace{4pt} \href{https://huwcheston.github.io/}{\underline{Webpage}} \hspace{4pt} $\mid$ \hspace{4pt} \href{https://www.github.com/huwcheston}{\underline{GitHub}} \hspace{4pt} $\mid$ \hspace{4pt} \href{https://huwcheston.github.io/portfolio}{\underline{Portfolio}} \hspace{4pt} $\mid$ \hspace{4pt} \href{https://scholar.google.com/citations?user=byas-BIAAAAJ&hl=en}{\underline{Google Scholar}} \hspace{4pt} $\mid$ \hspace{4pt} \href{https://twitter.com/huwcheston}{\underline{@HuwCheston}}}
%------------------------------------------------------------==--------------
%	EDUCATION 
%----------------------------------------------------------------------------
...
\-\hspace{.25in} \textbf{Thesis:} New Methods in Quantitative Analysis and Modeling of Musical Improvisation \\
\-\hspace{.25in} \emph{Supervisor:} Peter Harrison \& Ian Cross
...
\textsubscript{\textbf{TOPICS:} linear modelling, computer simulations, experiment software design, massive online experiments}
...
\textsubscript{\textbf{TOPICS:} machine learning, audio signal processing, music information retrieval, music classification}
...
\textsubscript{\textbf{TOPICS:} audio signal processing, music information retrieval, dataset, data pipeline}
\end{hangparas}
%----------------------------------------------------------------------------------------
%	AWARDS AND PRIZES
%----------------------------------------------------------------------------------------
...
\setlength\itemsep{0pt}
    ...
    \item[--]Machine learning pipelines (data cleaning, feature extraction, optimisation)
...
%----------------------------------------------------------------------------------------
\section{\centerline{FULL PUBLICATION LIST}}
\vspace{8pt} % Gap between title and text
\subsection{Articles}
\begin{hangparas}{.25in}{1}
\textbf{Cheston, H.}, Cross, I., \& Harrison, P. M. C. (2024, in press). Trade-offs in Coordination Strategies for Duet Jazz Performances Subject to Network Delay and Jitter. \emph{Music Perception}.
